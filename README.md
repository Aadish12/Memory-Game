A game in which the player must match all of the identical cards, with the number of turns increasing with each attempt until all of the cards are matched.
